...
const cards = [
  { title: "Before Cloud was Cool", icon: "", desc: "", backText: "This session introduces you to the basics of Cloud Computing and Microsoft Azure—what it is, why it matters, and how it changed everything. Learn about data centers, scalability, cloud models (IaaS, PaaS, SaaS), deployment types, and why Azure stands out against AWS and GCP. We’ll also walk you through the Azure Portal and its key services like Virtual Machines, Storage, Networking, and App Services." },
  { title: "Inside the Azure Engine", icon: "", desc: "", backText: "This session dives into the heart of Azure: Compute, Storage, and Networking. You’ll understand how Virtual Machines, serverless functions, Blob Storage, and Virtual Networks actually power businesses. We’ll also cover Azure Resource Manager (ARM)—the brain that manages everything in Azure. Plus, you’ll see a live demo of deploying a Resource Group + Storage using the Portal." },
  { title: "Deploy.Run.Wow", icon: "", desc: "", backText: "In this fully practical session, you’ll deploy your first Virtual Machine, set up a basic Web App with Azure App Service, and explore Azure Storage Services. This is your chance to apply what you’ve learned and see your work live on the cloud." },
  { title: "Hack4Azure", icon: "", desc: "", backText: "In the final session, you’ll participate in Hack4Azure, an exciting hackathon where you’ll put your Azure skills to the test. This is all about teamwork, creativity, and innovation—building real-world solutions powered by the cloud. Compete, learn, and showcase your ideas as you bring them to life with Azure." },
];
